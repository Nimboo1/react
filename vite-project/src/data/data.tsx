...
const data: CardData[] = [
  ...
  {
    id: 2,
    title: 'Рабочее оборудование VM J',
    description:
      'Стандартное навесное оборудование необходимо для выполнения операций с грунтами средней плотности. ',
    price: 300000,
    stock: 3,
    baseVehicle: 'JCB',
    category: 'Стрелы, рукояти',
    thumbnail: 'https://i.imgur.com/VCrzjYe.jpg',
    images: [
      'https://i.imgur.com/hQkjGEx.jpg',
      'https://i.imgur.com/P2HvbTG.jpg',
      'https://i.imgur.com/AamO4HT.jpg',
    ],
  },
  {
    id: 3,
    title: 'Оси, пальцы втулки VM C',
    description:
      'Пальцы (оси) для экскаваторов строительного класса (эксплуатационной массой до 75 тонн) производятся из стали 40Х.',
    price: 990000,
    stock: 4,
    baseVehicle: 'Caterpillar',
    category: 'Оси, втулки',
    thumbnail: 'https://i.imgur.com/cyO8AIx.jpg',
    images: ['https://i.imgur.com/4kb2ISw.jpg', 'https://i.imgur.com/rVutm8s.jpg'],
  },
  {
    id: 4,
    title: 'Ковш VM K',
  ...
  {
    id: 7,
    title: 'Система зубьев VM C',
    description:
      'В наличии и под заказ широкий спектр запасных частей на спецтехнику различных серий и модификаций.',
    price: 71000,
    stock: 2,
    baseVehicle: 'Caterpillar',
    category: 'Коронки, адаптеры',
    thumbnail: 'https://i.imgur.com/i92H2II.jpg',
    images: ['https://i.imgur.com/BTaMcia.jpg', 'https://i.imgur.com/Fu6vQuO.jpg'],
  },
  {
    id: 8,
    title: 'Оси, пальцы втулки VM J',
    description:
      'Пальцы (оси) для экскаваторов строительного класса (эксплуатационной массой до 75 тонн) производятся из стали 40Х.',
    price: 210000,
    stock: 11,
  ...
  {
    id: 15,
    title: 'Рабочее оборудование VM V',
    description:
      'Стандартное навесное оборудование необходимо для выполнения операций с грунтами средней плотности. ',
    price: 360000,
    stock: 8,
  ...
  {
    id: 16,
    title: 'Система зубьев VM L',
    description:
      'В наличии и под заказ широкий спектр запасных частей на спецтехнику различных серий и модификаций.',
    price: 45000,
    stock: 6,
    baseVehicle: 'Liebherr',
    category: 'Коронки, адаптеры',
    thumbnail: 'https://i.imgur.com/i92H2II.jpg',
    images: ['https://i.imgur.com/BTaMcia.jpg', 'https://i.imgur.com/Fu6vQuO.jpg'],
  },
  ...
  },
  {
    ...
    thumbnail: 'https://i.imgur.com/ewuCfwC.jpg',
    images: ['https://i.imgur.com/wcVOdDS.jpg', 'https://i.imgur.com/Ujg8Uee.jpg'],
  },
  {
    id: 22,
    title: 'Рабочее оборудование VM K',
    description:
      'Стандартное навесное оборудование необходимо для выполнения операций с грунтами средней плотности. ',
    price: 230000,
    stock: 2,
  ...
  {
    id: 30,
    title: 'Рабочее оборудование VM L',
    description:
      'Стандартное навесное оборудование необходимо для выполнения операций с грунтами средней плотности. ',
    price: 970000,
    stock: 6,
  ...
  {
    id: 37,
    title: 'Рабочее оборудование VM D',
    description:
      'Стандартное навесное оборудование необходимо для выполнения операций с грунтами средней плотности. ',
    price: 850000,
    stock: 1,
